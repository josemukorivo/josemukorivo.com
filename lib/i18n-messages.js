...
export const MESSAGES = Object.freeze({
  ...
  sn: {
    ...
    home: {
      ...
      introLocationPrefix: "Ndiri mu",
      locationEdit: {
        draft: "Gokwe",
        correction: "Harare"
      },
      introSummaryAfterLocation:
        ", Zimbabwe, uye ndava nemakore anodarika manomwe ndichivaka maAI products nemasoftware anoshandiswa zvechokwadi kuma product, data, cloud, nema regulated systems.",
      currentWorkPrefix: "Ndinotungamira engineering ku",
      currentWorkFounder: "ndakavhura",
      currentWorkJoin: "uye ndiri kuvaka",
      currentWorkAfter:
        "Basa iri rinosanganisa product direction, architecture, AI strategy, ne hands-on delivery.",
      introLocation:
  ...
  fr: {
    ...
    home: {
      ...
      introSummary:
        "Basé à Harare, au Zimbabwe, je construis depuis plus de sept ans des produits d’IA et des logiciels en production, du produit au cloud en passant par la donnée et les systèmes réglementés.",
      currentWorkPrefix: "Je dirige l’ingénierie chez",
      currentWorkFounder: "j’ai fondé",
      currentWorkJoin: "et je construis",
      currentWorkAfter:
        "Ce travail réunit direction produit, architecture, stratégie IA et réalisation concrète.",
      introLocation:
  ...
  es: {
    ...
    home: {
      ...
      introSummary:
        "Con base en Harare, Zimbabue, llevo más de siete años construyendo IA y software en producción para producto, datos, cloud y sistemas regulados.",
      currentWorkPrefix: "Lidero ingeniería en",
      currentWorkFounder: "fundé",
      currentWorkJoin: "y construyo",
      currentWorkAfter:
        "El trabajo abarca dirección de producto, arquitectura, estrategia de IA y entrega práctica.",
      introLocation:
