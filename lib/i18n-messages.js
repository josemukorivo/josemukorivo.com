...
export const MESSAGES = Object.freeze({
  ...
  sn: {
    ...
    home: {
      ...
      introLocation:
        "Harare, Zimbabwe 🇿🇼 ndiko kumba. Ndinogadzira ma software nema AI systems anoshandiswa zvechokwadi—kubva kuma secure full-stack products kusvika kuma agents, automation, nema workflows ekuti vanhu ndivo vanofinaliza ma decisions—zvinhu zvinogona kuvimbwa nazvo kupfuura kungova ma demo.",
      introBeforeEdit:
        "Harare, Zimbabwe 🇿🇼 ndiko kumba. Ndinogadzira ma software nema AI systems anoshandiswa zvechokwadi—kubva kuma secure full-stack products kusvika kuma agents, automation, nema workflows ekuti vanhu ndivo vanofinaliza ma decisions—zvinhu zvinogona kuvimbwa nazvo kupfuura kungova ma",
      locationEdit: {
        draft: "Gokwe",
        correction: "Harare",
        after:
          ", Zimbabwe 🇿🇼 ndiko kumba. Ndinogadzira ma software nema AI systems anoshandiswa zvechokwadi—kubva kuma secure full-stack products kusvika kuma agents, automation, nema workflows ekuti vanhu ndivo vanofinaliza ma decisions—zvinhu zvinogona kuvimbwa nazvo kupfuura kungova ma"
      },
      introDraft: "prototype",
      introCorrection: "demo",
      ...
      founderAfterBeforeEdit:
        "inobatsira paagentic project management, ichibatanidza ma goals ecompany, feedback kubva kuma customers, planning, neku delivery. Parizvino ndinotungamira engineering kuArt Circles, ndichiseta technical direction, AI strategy, nekuona kuti ma products",
      founderDraft: "anoshanda",
      founderCorrection: "asvika chaipo chaipo 😂",
      ...
      liveProduct: "Live product",
      buildingIntroBeforeEdit: "FortyOne i",
      buildingIntroDraft: "imwe Jira futi",
      buildingIntroCorrection: "agentic project management system",
      buildingIntroAfterEdit:
        "inobatanidza strategy, customer feedback, planning, ne daily delivery. Ndakagadzira Maya (AI agent wangu) kuti achinje ma requests kuita planned work, ape suggestions dzeowners nema estimates, apindure mibvunzo yeworkspace, uye aratidze delivery risks achichengeta ma changes akakosha achigona kureviewiwa.",
      buildingParagraphs: [
        "FortyOne iagentic project management system inobatanidza strategy, customer feedback, planning, ne daily delivery. Ndakagadzira Maya (AI agent wangu) kuti achinje ma requests kuita planned work, ape suggestions dzeowners nema estimates, apindure mibvunzo yeworkspace, uye aratidze delivery risks achichengeta ma changes akakosha achigona kureviewiwa.",
