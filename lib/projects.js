export const projects = [
  {
    ...
    shortDescription: "Agentic project management with built-in feedback.",
    description:
      "An agentic project management platform where Maya helps teams plan and deliver work, act on customer feedback, and keep important AI-assisted changes reviewable."
  },
  {
    id: "config",
    name: "Config",
    ...
    domain: "github.com",
    image: "/assets/previews/config-concept.png",
    shortDescription: "Reliable configuration for Go applications.",
    description:
  ...
  },
  {
    ...
    domain: "complexus.tech",
    image: "/assets/previews/complexus-home.png",
    shortDescription: "Product engineering and practical AI for complex work.",
    description:
