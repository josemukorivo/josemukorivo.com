...
export const BlogMenu = () => {
  return (
    <Box className='hidden md:block pt-4 border-slate-300 dark:bg-slate-900 dark:bg-opacity-80 backdrop-blur z-10 dark:border-slate-700 border-b fixed left-[81px] 2xl:left-[100px] right-0 top-0'>
