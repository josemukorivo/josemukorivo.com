    ...
    >
      <Box className='absolute dark:text-white inset-0 flex flex-col justify-between p-3 py-4 md:p-5'>
        <Box className='flex justify-between 2xl:mt-5'>
          <Text className='text-slate-600 text-xs md:text-base dark:text-slate-400 font-medium'>
            {readTime} min read
          </Text>
          <Text className='text-slate-600 text-xs md:text-base dark:text-slate-400 font-medium'>
        ...
        <Text className='text-base md:text-3xl 2xl:text-4xl dark:text-white font-medium mb-0'>
          {title}
        </Text>
      </Box>
    </Link>
